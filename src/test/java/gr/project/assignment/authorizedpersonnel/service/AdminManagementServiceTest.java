...
import gr.project.assignment.authorizedpersonnel.service.AdminManagementServiceImpl;
...
class AdminManagementServiceTest {
    ...
    void createAuthPersonnel_shouldEncodePasswordAndSave() {
        ...
        // when(SecurityContextHolder.getContext().getAuthentication().getName()).thenReturn("Balance
        // Admin");
